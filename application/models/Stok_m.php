...
class Stok_m extends CI_Model
{
    ...
    {
        $sql = "SELECT d.id_stok, a.barcode, a.nama_barang, d.jenis, d.nilai, d.keterangan, d.tanggal, d.jml, c.satuan FROM  barang a, satuan c, stok d WHERE a.id_satuan = c.id_satuan AND d.id_barang = a.id_barang";
