...
class Customer_m extends CI_Model
{
    ...
    public function Save()
    {
        ...
        $data = array(
            ...
            'tanggal_booking' => htmlspecialchars($this->input->post('tanggalbooking'), true)
        );
    ...
    public function Edit()
    {
        ...
        $data = array(
            ...
            'tanggal_booking' => htmlspecialchars($this->input->post('edittanggalbooking'), true)
        );
    ...
    {
        $sql = "SELECT a.id_cs, a.nama_cs, a.alamat, a.kode_cs, a.telp, COUNT(b.id_cs) AS total FROM customer a, penjualan b WHERE a.id_cs = b.id_cs GROUP BY b.id_cs";
