		 					...
		 					<div class="x_content">
		 						...
		 						<div class="col-md-9 col-sm-9 col-xs-12">
		 							...
		 							<form class="form-horizontal" method="post" action="<?php echo base_url('profil/index') ?>" enctype="multipart/form-data">
		 								...
		 								<div class="form-group">
		 									<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
		 										<input type="number" class="form-control" id="telp" name="telp" placeholder="Telp" value="<?php echo $toko->telp_toko ?>" autocomplete="off">
		 								...
		 								<div class="form-group">
		 									<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
		 										<input type="email" class="form-control has-feedback-left" id="email" name="email" placeholder="Email" value="<?php echo $toko->email_toko ?>" autocomplete="off">
